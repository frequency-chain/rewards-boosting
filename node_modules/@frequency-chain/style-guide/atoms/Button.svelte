<script lang="ts">import Typography from '../design-system/Typography.svelte';
import { cn } from '../utils/utils';
import { cva } from 'class-variance-authority';
const button = cva(['h-[46px]', 'px-f24', 'cursor-pointer', 'rounded-full', 'text-center', 'transition-all', 'text-nowrap'], {
    variants: {
        intent: {
...
let { href = '', intent = 'filled-dark', size = 'normal', disabled = false, active = false, target = '', children, ...rest } = $props();
</script>
